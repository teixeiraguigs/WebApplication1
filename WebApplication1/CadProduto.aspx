<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="CadProduto.aspx.cs" Inherits="WebApplication1.CadProduto" %>
        ...
        <ContentTemplate>
            ...
            <div >
                <table>
                    ...
                    <tr>
                        <td><span style="margin-left:17px;">Categoria</span></td>
                        <td>
                            <asp:DropDownList ID="ddlCategoria" runat="server" CssClass="form-control" style="width:125px;">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td><span style="margin-left:17px;">Preço</span></td>
                        <td>
                            <asp:TextBox ID="txtPreco" runat="server" CssClass="form-control" style="width:85px;" />
                        </td>
                    </tr>
                </table>
            <br />
